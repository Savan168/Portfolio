$(document).ready(function(){
  ...
  const projectsCart = [
    ...
    {image:'filedonwload/DHCP, DNS, Web Server.png', title:'Fidora Server: DHCP DNS and Web Server',Link:'filedonwload/DHCP, DNS, Web Server.pdf'},
    {image:'filedonwload/Mail Server.png', title:'Fidora Server: Mail Server',Link:'filedonwload/Mail Server.pdf'},
    {image:'filedonwload/SSH.png', title:'Fidora Server: SSH',Link:'filedonwload/SSH.pdf'},
    ...
    getprojectsCart +=`
      <div class="bg-gray-200 rounded-md  lg:h-[370px] h-full lg:px-0 ">
          ...
          <div class="h-[25%] lg:p-4 p-3"> 
            <h1 class="lg:mb-3 mb-2"><b>${val.title}</b></h1>
